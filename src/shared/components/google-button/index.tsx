...
const GoogleButton = () => {
  ...
  return (
    <button className="flex items-center justify-center gap-3 px-4 py-3 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors duration-200 w-full">
      {/* Google SVG Icon */}
      ...
      <span className="text-gray-700 font-medium text-sm">{buttonText}</span>
    </button>
  );
};
